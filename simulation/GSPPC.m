...
% ±rho_global
plot(t,  rho_std, '--','LineWidth',1.5,'Color',col_error,'DisplayName','$\pm \rho_{\mathrm{PPF}}(t)$');
plot(t, -rho_std, '--','LineWidth',1.5,'Color',col_error,'HandleVisibility','off');

% ±rho_adapt
plot(t,  rho_adapt,  '-','LineWidth',1.5,'Color',col_global,'DisplayName','$\pm \rho_{\mathrm{gPPF}}(t)$');
...
hTp = xline(Tp,'k--','$T_p$','LabelVerticalAlignment','bottom','LabelOrientation','horizontal',  'HandleVisibility','off','Interpreter','latex');
